...
@Component({
  selector: 'app-edformsub',
  templateUrl: './edformsub.component.html',
  styleUrls: ['./edformsub.component.css']
})
export class EdformsubComponent implements OnInit {
  ...
  public editar():void{
    this.subcatoService.editar(this.subcategoria).subscribe(
